...
export default function Sliderqasadthree() {
  ...
  function getAllLastNews() {
    return axios.get(
      `https://syrianrevolution1.com/childData/search?category=missing&responsibleAuthority=qasad&page=2&limit=${num}`
    );
  }
  const { data } = useQuery("missingqasadSystemSlider", getAllLastNews, {
    cacheTime: 1800000,
  });
