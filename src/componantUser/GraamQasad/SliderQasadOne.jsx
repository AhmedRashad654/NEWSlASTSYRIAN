...
export default function SliderQasadOne() {
  ...
  function getAllLastNews() {
    return axios.get(
      `https://syrianrevolution1.com/childData/search?category=martyr&responsibleAuthority=qasad&page=2&limit=${num}`
    );
  }
  const { data } = useQuery("martergqasadSystemSlider", getAllLastNews, {
    cacheTime: 1800000,
  });
  //////////////////////////
