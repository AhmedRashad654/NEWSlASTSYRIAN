...
export default function SliderGraemTwo() {
  const navigate = useNavigate();
     ...
     function getAllLastNews() {
       return axios.get(
         `https://syrianrevolution1.com/childData/search?category=adetaine&responsibleAuthority=qasad&page=2&limit=${num}`
       );
     }
     const { data } = useQuery("adetainegqasadSystemSlider", getAllLastNews, {
       cacheTime: 1800000,
     } );
  //////////////////////////
